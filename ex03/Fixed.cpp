...
Fixed	Fixed::operator*( const Fixed& other ) const
{
	...
	temp = (long)this->_fixed_point * other._fixed_point;
...
Fixed	Fixed::operator/( const Fixed& other ) const
{
	...
	temp = ((long)this->_fixed_point << _fractional_bits) / other._fixed_point;
...
bool	Fixed::operator==( const Fixed& other ) const
{
	return (std::fabs(this->toFloat() - other.toFloat()) < _epsilon);
}
...
bool	Fixed::operator==( int n ) const
{
	return (std::fabs(this->toFloat() - static_cast<float>(n)) < _epsilon);
}
...
bool	Fixed::operator==( float f ) const
{
	return (std::fabs(this->toFloat() - f) < _epsilon);
}
